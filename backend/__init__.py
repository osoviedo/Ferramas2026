...
def create_app():
    ...
    from backend.api.producto_api import api_bp
    from backend.views.auth import auth_bp
    from backend.views.tienda import tienda_bp
    from backend.views.carrito import carrito_bp
    from backend.views.vendedor import vendedor_bp
    from backend.views.bodeguero import bodeguero_bp
